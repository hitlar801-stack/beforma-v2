"""Optional SQLAlchemy persistence for generated plans.
Works with Railway PostgreSQL through DATABASE_URL; falls back to local SQLite.
If SQLAlchemy is not installed, DB saving becomes a no-op so the API still runs.
"""
